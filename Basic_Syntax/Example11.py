...
# text_file = open("Basic_Syntax/text.txt", "w", encoding="utf8")
...
# text_file = open("Basic_Syntax/text.txt", "a", encoding="utf8")
# print("==========", file=text_file)
# text_file.write("text save2")
# text_file.close()


text_file = open("Basic_Syntax/text.txt", "r", encoding="utf8")
